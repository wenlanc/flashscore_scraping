...
jQuery(document).ready(function() {
    ...
    $('#country_id').on('change', function(e) {  
        ...
        $("#country_link").val($('#country_id').find(":selected").attr('data-name'));    
    });
    ...
    $('#league_id').on('change', function(e) {
        if($(this).val() != "" ){
            if ($(this).val() == "0") {
                ...
                $('#season_id').attr('disabled',false);
                $('#season_from').attr('disabled',false);
                $('#season_to').attr('disabled',false);
                $.ajax({
                    type: 'POST',
